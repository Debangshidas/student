<html lang="en">
  <head>
    ...
    <!-- //web fonts -->
    <!-- Template CSS -->
    <link rel="stylesheet" href="page/assets/css/style-starter.css">
  </head>
  <body>
...
<section class="w3l-top-menu-1">
	...
	<header class="row top-menu-top">
		<div class="accounts col-md-9 col-6">
				<li class="top_li"><span class="fa fa-phone"></span><a href="tel:+142 5897555">+917005151993</a> </li>
				<li class="top_li1"><span class="fa fa-envelope-o"></span> <a href="mailto:education-mail@support.com" class="mail">dasdebangshi90@gmail.com</a>	</li>
		</div>
		<div class="social-top col-md-3 col-6">
			<a href="page/contact.php" class="btn btn-secondary btn-theme4">Apply Now</a>
		</div>
	</header>
</div>
</div>
...
<section class="w3l-bootstrap-header">
  <nav class="navbar navbar-expand-lg navbar-light py-lg-2 py-2">
    <div class="container">
      <a class="navbar-brand" href="index.php"><span class="fa fa-pencil-square-o "></span> Institute</a>
    ...
    <a class="navbar-brand" href="#index.html">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto">
		  ...
		  <li class="nav-item">
            <!--<a class="nav-link" href="../stureg.html">Registration</a>-->
			<a class="nav-link" href="page/stureg.php">Registration</a>
          </li>
        </ul>
            ...
            <div class="banner-info">
              <div class="container">
                <div class="banner-info-bg mx-auto text-center">
                 ...
                 <a class="btn btn-secondary btn-theme2 mt-md-5 mt-4" href="page/services.php">Read More</a>
                </div>
		...
		<div class="container">
			...
			<div class="middle-section grid-column text-center">
				<div class="three-grids-columns">
					...
					<p>Online learning is one of the fastest-growing modes of education and people are widely accepting it.
					There are a variety of courses and they can easily be accessed online..</p>
					<a href="page/services.php" class="btn btn-secondary btn-theme3 mt-4">Read More </a>
				</div>
				<div class="three-grids-columns">
					<span class="fa fa-users"></span>
					<h4>Highly Qualified Teachers</h4>
					<p>The requirement that teacher be highly qualified applies to all public elementary or secondary school teachers
					employed by a local educational agency who teach a core academic subject..</p>
					<a href="services.html" class="btn btn-secondary btn-theme3 mt-4">Read More </a>
				</div>
				<div class="three-grids-columns">
					<span class="fa fa-book"></span>
					<h4>Book Library & Stores</h4>
					<p>The library is well settled at the next corner of the institute where the lots of knowledgeable books are available.
					All types of facilities are included in the libraray .And then we have Bookshop Day on saturday 8th oct..</p>
					<a href="services.html" class="btn btn-secondary btn-theme3 mt-4">Read More </a>
				</div>
			</div>
		</div>
		...
		<div class="container py-md-3">
			...
			<div class="calltoaction-20-content row">
				<div class="column center-align-self col-lg-6 pr-lg-5">
					...
					<p align="justify" class="more-gap editContent" >Presently the Institute offers eight UG courses and PG courses in several fields along with Post Doctoral Fellowships. This Institute is autonomous under NIT being act passed by the parliament.

The Institute recently introduced a new curriculum in the line of IITs where more number of elective subjects are being offered to make the system flexible. Previously, the Institute used to follow the mark based system of evaluation, but have been switching over to credit based system in order to keep track with the global evaluation methods. Industrial training, Undertaking projects are parts of the education system and students are also encouraged to take various activities for social development through NSS and NCC.

Presently the Institute offers eight UG courses and PG courses in several fields along with Post Doctoral Fellowships. This Institute is autonomous under NIT being act passed by the parliament.</p>
						
							<!--<a class="btn btn-secondary btn-theme2 mt-3" href="about.html"> Read More</a>-->
				</div>
				<div class="column ccont-left col-lg-6">
					<img src="page/assets/images/g1.jpg" class="img-responsive" alt="#">
				</div>
			</div>
		</div>
	</div>
			...
			<div class="grid grid-column-2 ">
				...
				<div class="column1">
					<div class="heading">
						...
						<h4>Fall 2024 applications are now open</h4>
						<p class="my-3 text-white"> Many companies,organizations and Individuals award scholarships to students who meet their
						criteria as ideal candidates. Scholarship provides deserving students with the financial means to pursue higher 
						education. If you plan to enter college soon,learning about how to apply for scholarship.
						  
						  </p>
					  </div>
					</div>
					<div class="column2">
						<a class="btn btn-secondary btn-theme2 mt-3" href="page/contact.html"> Apply Here</a>
					</div>
			</div>
		</div>
	</div>
        ...
        <div class="heading">
          ...
          <div class="item-top col-md-6 mt-md-0 mt-4">
            <div class="item text-center">
             <div class="imgTitle">
               <img src="page/assets/images/c3.jpg" class="img-responsive" alt="" />
              </div>
              ...
              <div class="pricing-chart col-lg-6">
                ...
                <div class="tatest-top mt-md-5 mt-4">
                        <div class="price-box btn-layout bt6">
                            <div class="grid grid-column-2">
                                    <div class="column-6">
                                            <img src="page/assets/images/g9.jpg" alt="" class="img-fluid">
                                        </div>
                                <div class="column1">
                        ...
                        <div class="price-box btn-layout bt6 top-middle-1">
                            <div class="grid grid-column-2">
                                    <div class="column-6">
                                            <img src="page/assets/images/g10.jpg" alt="" class="img-fluid">
                                        </div>
                                <div class="column1">
                                   <div class="job-info">
                                       ...
                                       <h5>March 25, 2020</h5>
                                       <p>A set of technologies that enable computers to perform a variety of advanced functions...</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="price-box btn-layout bt6">
                            <div class="grid grid-column-2">
                                    <div class="column-6">
                                            <img src="page/assets/images/g8.jpg" alt="" class="img-fluid">
                                        </div>
                                <div class="column1">
      ...
      <div class="container">
          <div class="d-grid grid-col-4 footer-top-29">
              <div class="footer-list-29 footer-1">
                  ...
                  <ul>
                      <li><p><span class="fa fa-map-marker"></span> State Business, #328 block, #The Indian Service building, Agartala</p></li>
                      <li><a href="tel:+7-800-999-800"><span class="fa fa-phone"></span>(+91)87877412962</a></li>
              ...
              <div class="footer-list-29 footer-2">
                  <ul>
                      ...
                      <li><a href="page/contact.html">Graduation</a></li>
                      <li><a href="page/contact.html">Admissions</a></li>
                      <li><a href="page/contact.html">Book Store</a></li>
                      <li><a href="page/contact.html">International</a></li>
                      <li><a href="page/contact.html">Courses</a></li>
                  </ul>
              </div>
...
<script src="page/assets/js/jquery-3.3.1.min.js"></script>
<!-- //footer-28 block -->
</section>
<script>
  $(function () {
...
<!-- Template JavaScript -->
<script src="page/assets/js/all.js"></script>
<!-- Smooth scrolling -->
