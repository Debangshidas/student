    ...
    <a class="navbar-brand" href="#index.html">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto">
		  ...
		  <li class="nav-item">
            <a class="nav-link" href="stureg.php">Registration</a>
          </li>
        </ul>
        ...
        <div class="container py-md-5">
            <div class="cwp4-two row">
                ...
                <div class="cwp4-text col-lg-6">
                    ...
                    <p>The National Institute of Technology Agartala has been constitued by the honourable Govt.of India with the mission to heraid a ner 
					chapter of development in the country,particularly,in the North-East states, through pursuit of excellence in technical education and
					research. In an era of reaissance in technical education in north east,the honourable Ministry of education has conferred the status 
					of National importance"to the institute with a deemed to be university decree..
                    </p>
			...
			<div class="fea-gd-vv row ">	
			   <div class="float-lt feature-gd col-lg-4 col-sm-6">	
					 ...
					 <div class="icon-info">
						...
						<p>The institute was established in 1965 at Tripura Enguneering college,with the branches of civil,electrical and mechanical enge=ineering.
						It was initially affiliated with calcutta university and had the same curriculum structure and examination system as IIEST,shibpur.
						</p>
					</div>
				...
				<div class="float-mid feature-gd col-lg-4 col-sm-6 mt-sm-0 mt-4">	
					 ...
					 <div class="icon-info">
						...
						<p>There are more than above 100 facalties in the college where tachers are with higher qualified teaching capacities with their
				...
				<div class="float-rt feature-gd col-lg-4 col-sm-6 mt-lg-0 mt-4">	
					 ...
					 <div class="icon-info">
						<h5>We Have 12,000 Students</h5>
				         <p>There are more than or above 12,000 students in the institute.
						 From all over the india students are permitted to get addmitted in the institute with their eligible jee ranks.
						</p>
					</div>
			 </div>	 
		...
		<div class="grid top-bottom py-5">
			<div class="container py-md-5">
				<div class="heading text-center mx-auto">
					...
					<p class="my-3 head">I've chosen your place for two main reasons.First one is the study program.I went through the curriculum for all four years.
					second reason is your location.I know the city well, like it a lot,especially the surrounding nature, and I can imagine living there  for the next
					few years at least..
				...
				<div class="middle-section row mt-5 pt-3">
					<div class="three-grids-columns col-lg-3 col-sm-6 text-center">
						...
						<p>It helps in empowering your academic and career goals by removing the financial barrier.
						Getting a scholarship takes away all your financial concerns.Thus,it gives you more time to study,
						gain knowledge and secure better grades..</p>
					</div>
					<div class="three-grids-columns col-lg-3 col-sm-6 mt-sm-0 mt-5 text-center">
						...
						<p>Top  qualities and good skills are very important for a skilled lecturers.It includes patience,
						Empathy,Drive for self-improvement,Adaptable etc..</p>
					</div>
					<div class="three-grids-columns col-lg-3 col-sm-6 mt-lg-0 mt-5 text-center">
						...
						<h4> Library & Store</h4>
						<p>A place set apart to contain books,periodicals,and other materials for reading,viewing,listening,study.
						library buildings often provide quite areas for studying as well as common areas for group study and
						collaborations and mayprovide public facilities for access to their electronic resourses..</p>
					</div>
					<div class="three-grids-columns col-lg-3 col-sm-6 mt-lg-0 mt-5 text-center">
						<div class="icon"> <span class="fa fa-bed" aria-hidden="true"></span></div>
						<h4>Hostel Facilities</h4>
						<p>i)Mess,canteen,RO water system,hot water spply through geysers in winter.
						ii)Daily newspaper(Hindi & English) and Tvfacility.
						iii)Internet and wifi facility.
						iv)sports(indoor & outdoor)and gym facility is also available seperately in boys and girls hostel..</p>
					</div>
				</div>
			</div>
		</div>
