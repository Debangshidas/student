<html lang="en">
  <head>
    ...
    <title>Mastery a Education Category Bootstrap Responsive Website Template | Contact :: W3layouts</title>
    <!-- web fonts -->
            ...
            <div class="row cont-main-top">
                    ...
                    <div class="cont-subs">
                        <div class="cont-add">
                           ...
                           <div class="cont-add-rgt">
                            <h4>Address:</h4>
                            <p class="contact-text-sub">NIT Agartala,Barjala,jirania,Agartala,Tripura 799046.</p>
                        </div>
                        ...
                        <div class="cont-add add-2">
                           ...
                           <div class="cont-add-rgt">
                            ...
                            <a href="mailto:info@example.com">
                                <p class="contact-text-sub">dasdebangshi90@gmail.com</p>
                            </a>
                        </div>
                        <div class="cont-add-lft">
                        ...
                        <div class="cont-add">
                            ...
                            <div class="cont-add-rgt">
                                 ...
                                 <a href="tel:+7-800-999-800">
                                    <p class="contact-text-sub">(+91)87877412962</p>
                                 </a>
                            </div>
                            <div class="cont-add-lft">
                ...
                <!-- //contact address -->
                 ...
                 <div class="contacts12-main col-lg-8 mt-lg-0 mt-5">
                    ...
                    <form action="addng.php" method="post" class="main-input">
                        ...
                        <div class="text-right">
                            <button type="submit" class="btn btn-theme2" name="addng">Submit Now</button>
                        </div>
                    </form>
                </div>
                <!-- //contact form -->
